...
call s:At('|t.{->$<MyCoolType>}<MyCoolType>|matched()', '.', 'meowyDispatch')
call s:At('|t.{->$<MyCoolType>}<MyCoolType>|matched()', '$', 'meowyReceiver')
call s:At('|t.{->$<MyCoolType>}<MyCoolType>|matched()', 'MyCoolType', 'meowyTypeName')
call s:At('|t.{->$<MyCoolType>}<MyCoolType>|matched()', '}<MyCoolType', 'meowyTypeName', 2)
call s:At('|t.{->$<MyCoolType>}<MyCoolType>|matched()', 'matched', 'meowyCall')
