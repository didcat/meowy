...
call s:At('projected : result~<uint32>', '~', 'meowyAscription')
...
call s:At('| enabled<boolean> && enabled~<boolean> | debug.print("Enabled")', 'boolean', 'meowyTypeName')
call s:At('| enabled<boolean> && enabled~<boolean> | debug.print("Enabled")', '~', 'meowyAscription')
call s:At('| enabled<boolean> && enabled~<boolean> | debug.print("Enabled")', '~<boolean>', 'meowyTypeName', 2)
call s:At('| enabled<boolean> && enabled~<boolean> | debug.print("Enabled")', '&&', 'meowyOperator')
call s:At('| enabled<boolean> && enabled~<boolean> | debug.print("Enabled")', 'print', 'meowyCall')
call s:At('predicate : value<int32>', 'value', 'meowyIdentifier')
call s:At('predicate : value<int32>', 'int32', 'meowyTypeName')
call s:At('copy:value ~ < int32 >', '~', 'meowyAscription')
call s:At('copy:value ~ < int32 >', 'int32', 'meowyTypeName')
call s:At('chained : value~<Choice><int32>', '~', 'meowyAscription')
call s:At('chained : value~<Choice><int32>', 'Choice', 'meowyTypeName')
call s:At('chained : value~<Choice><int32>', 'int32', 'meowyTypeName')
call s:At('field : value~<Record>.field', 'Record', 'meowyTypeName')
call s:At('field : value~<Record>.field', '.field', 'meowyIdentifier', 1)
call s:At('ascribed_generic : item~<D<string, uint32, boolean, string>>', '~', 'meowyAscription')
for s:type in ['D', 'string', 'uint32', 'boolean']
  call s:At('ascribed_generic : item~<D<string, uint32, boolean, string>>', s:type, 'meowyTypeName')
endfor
call s:At('receiver_ascription : value.{ -> $~<MyCoolType> }', '$', 'meowyReceiver')
call s:At('receiver_ascription : value.{ -> $~<MyCoolType> }', '~', 'meowyAscription')
call s:At('receiver_ascription : value.{ -> $~<MyCoolType> }', 'MyCoolType', 'meowyTypeName')
call s:At('multiline_ascription : value~', '~', 'meowyAscription')
call s:At('    <Choice>', 'Choice', 'meowyTypeName')
call s:At('quoted_ascription : "value~<Choice>"', '~', 'meowyString')
call s:At('quoted_ascription : "value~<Choice>"', 'Choice', 'meowyString')
call s:At('# value~<Choice> #', '~', 'meowyComment')
call s:At('# value~<Choice> #', 'Choice', 'meowyComment')
call s:At('interpolated_ascription : "value: {value~<int32>} tail"', '~', 'meowyAscription')
call s:At('interpolated_ascription : "value: {value~<int32>} tail"', 'int32', 'meowyTypeName')
call s:At('interpolated_ascription : "value: {value~<int32>} tail"', 'tail', 'meowyString')
...
call s:At('bits : @"bits"', '@"bits"', 'meowyImport')
call s:At('mask : bits.and(bits.or(left, right), 0xff)', 'and', 'meowyCall')
call s:At('mask : bits.and(bits.or(left, right), 0xff)', 'or', 'meowyCall')
call s:At('xor : bits.xor(left, right)', '.xor', 'meowyCall', 1)
call s:At('complement : bits.not(mask)', 'not', 'meowyCall')
call s:At('removed_complement : ~mask', '~', '')
call s:At('removed_xor : left ^ right', '^', '')
...
call s:At('"".(print, "")', 'print', 'meowyCall')
call s:At('"".(print, "", "", "", "")', 'print', 'meowyCall')
call s:At('value.(print, first, second, third, fourth)', 'print', 'meowyCall')
call s:At('value.(print, first, second, third, fourth)', 'first', 'meowyIdentifier')
call s:At('value.(print, first, second, third, fourth)', 'fourth', 'meowyIdentifier')
call s:At('value.(transforms.convert, argument)', 'transforms', 'meowyIdentifier')
call s:At('value.(transforms.convert, argument)', 'convert', 'meowyCall')
call s:At('value.(transforms.convert, argument)', 'argument', 'meowyIdentifier')
call s:At('value.(convert, handler)', 'handler', 'meowyIdentifier')
call s:At('    print, ""', 'print', 'meowyCall')
call s:At('consume(print, "")', 'print', 'meowyIdentifier')
...
call s:At('    .{ -> $ }', '.', 'meowyDispatch')
call s:At('    .{ -> $ }', '$', 'meowyReceiver')
call s:At('receiver_field : value.{ -> $.field }', '$', 'meowyReceiver')
call s:At('receiver_field : value.{ -> $.field }', 'field }', 'meowyIdentifier')
call s:At('receiver_borrow : value.{ -> &$ }', '&$', 'meowyBorrow')
call s:At('receiver_borrow : value.{ -> &$ }', '$', 'meowyReceiver')
call s:At('receiver_query : value.{ -> $<> }', '$', 'meowyReceiver')
call s:At('receiver_query : value.{ -> $<> }', '<>', 'meowyTypeDelimiter')
call s:At('receiver_string : "$ stays literal; {$} is an expression"', '$ stays', 'meowyString')
call s:At('receiver_string : "$ stays literal; {$} is an expression"', '{$}', 'meowyReceiver', 1)
