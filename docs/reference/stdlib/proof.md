...
| Unary integer `-`, `bits.not`                                                | Calculate finite images or exact interval images, intersect with the result type, then canonicalize.                                                             |
| Integer `/`, `%`, `bits.and`, `bits.or`, `bits.xor`                    | Calculate finite-set pairs exactly; otherwise use the full result-type domain.                                                                                  |
