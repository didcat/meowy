...
pub(crate) struct Checker {
    ...
    pub(crate) coercions: BTreeMap<hir::PointId, dependencies::Coercion>,
    pub(crate) coercion_edges: usize,
    pub(crate) binaries: BTreeMap<hir::PointId, dependencies::Binary>,
    pub(crate) binary_edges: usize,
